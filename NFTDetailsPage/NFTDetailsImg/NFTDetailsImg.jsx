  ...
  return (
    <div className={Style.NFTDetailsImg}>
        <div className={Style.NFTDetailsImg_box}>
            ...
            <p>Description</p>
            {description ? <TiArrowSortedDown/> : <TiArrowSortedDown/>}
            </div>

            {description && (
                <div className={Style.NFTDetailsImg_box_description_box}>
                <p>Tattooed Kitty Gang (“TKG”) is a collection of 666 badass kitty
            ...
            onClick={()=>openDetails()}>
            <p>Details</p>
            {details ? <TiArrowSortedDown/> : <TiArrowSortedDown/>}
            </div>
